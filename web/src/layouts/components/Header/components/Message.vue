          ...
          <div class="message-list">
            <div class="message-item">
              ...
              <div class="message-content">
                <span class="message-title">有 4 笔订单待发货已逾期，请尽快处理</span>
                <span class="message-date">十分钟前</span>
              </div>
            </div>
            <div class="message-item">
              <img src="@/assets/images/msg02.png" alt="" class="message-icon" />
              <div class="message-content">
                <span class="message-title">平台佣金账单尚未同步，部分订单核算不完整</span>
                <span class="message-date">两小时前</span>
              </div>
            </div>
            <div class="message-item">
              <img src="@/assets/images/msg03.png" alt="" class="message-icon" />
              <div class="message-content">
                <span class="message-title">昨日结算数据已更新，可查看看板</span>
                <span class="message-date">今天 09:12</span>
              </div>
            </div>
          </div>
        </el-tab-pane>
